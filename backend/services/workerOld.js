...
// Initialize Kafka consumer with adjusted settings
...
const consumer = kafka.consumer({
  groupId: 'abr-group',
  sessionTimeout: 90000, // 90 seconds to accommodate long encoding tasks
  heartbeatInterval: 30000, // 1/3 of sessionTimeout
  retry: { retries: 5 }, // Retry on transient errors
});
...
async function runWorker() {
  try {
    ...
    await consumer.run({
      autoCommit: false, // Disable auto-commit to manually control offsets
